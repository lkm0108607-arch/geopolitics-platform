...
export interface KoreanETF {
  ...
  nameKr: string;     // 네이버 금융 공식 종목명 (name과 동일)
  category: string;
  subCategory: string;
  provider: string;
...
export const koreanETFs: KoreanETF[] = [
  ...
  { ticker: "394670", name: "TIGER 글로벌리튬&2차전지SOLACTIVE(합성)", nameKr: "TIGER 글로벌리튬&2차전지SOLACTIVE(합성)", category: "국내주식", subCategory: "2차전지", provider: "미래에셋", isRecommended: false },
  ...
  { ticker: "381180", name: "TIGER 미국필라델피아반도체나스닥", nameKr: "TIGER 미국필라델피아반도체나스닥", category: "해외주식", subCategory: "미국반도체", provider: "미래에셋", isRecommended: true },
  ...
  { ticker: "381170", name: "TIGER 미국테크TOP10 INDXX", nameKr: "TIGER 미국테크TOP10 INDXX", category: "해외주식", subCategory: "미국기술", provider: "미래에셋", isRecommended: false },
  { ticker: "411420", name: "KODEX 미국나스닥AI테크액티브", nameKr: "KODEX 미국나스닥AI테크액티브", category: "해외주식", subCategory: "미국AI", provider: "삼성", isRecommended: false },
  { ticker: "409820", name: "KODEX 미국나스닥100레버리지(합성 H)", nameKr: "KODEX 미국나스닥100레버리지(합성 H)", category: "해외주식", subCategory: "미국레버리지", provider: "삼성", isRecommended: false },
  { ticker: "409810", name: "KODEX 미국나스닥100선물인버스(H)", nameKr: "KODEX 미국나스닥100선물인버스(H)", category: "해외주식", subCategory: "미국인버스", provider: "삼성", isRecommended: false },
  { ticker: "456250", name: "KODEX 유럽명품TOP10 STOXX", nameKr: "KODEX 유럽명품TOP10 STOXX", category: "해외주식", subCategory: "유럽", provider: "삼성", isRecommended: false },
  { ticker: "195930", name: "TIGER 유로스탁스50(합성 H)", nameKr: "TIGER 유로스탁스50(합성 H)", category: "해외주식", subCategory: "유럽", provider: "미래에셋", isRecommended: false },
  ...
  { ticker: "371460", name: "TIGER 차이나전기차SOLACTIVE", nameKr: "TIGER 차이나전기차SOLACTIVE", category: "해외주식", subCategory: "중국", provider: "미래에셋", isRecommended: false },
  { ticker: "371160", name: "TIGER 차이나항셍테크", nameKr: "TIGER 차이나항셍테크", category: "해외주식", subCategory: "중국", provider: "미래에셋", isRecommended: false },
  { ticker: "396510", name: "TIGER 차이나클린에너지SOLACTIVE", nameKr: "TIGER 차이나클린에너지SOLACTIVE", category: "해외주식", subCategory: "중국", provider: "미래에셋", isRecommended: false },
  { ticker: "396520", name: "TIGER 차이나반도체FACTSET", nameKr: "TIGER 차이나반도체FACTSET", category: "해외주식", subCategory: "중국", provider: "미래에셋", isRecommended: false },
  ...
  { ticker: "236350", name: "TIGER 인도니프티50레버리지(합성)", nameKr: "TIGER 인도니프티50레버리지(합성)", category: "해외주식", subCategory: "인도", provider: "미래에셋", isRecommended: false },
  { ticker: "453820", name: "KODEX 인도Nifty50레버리지(합성)", nameKr: "KODEX 인도Nifty50레버리지(합성)", category: "해외주식", subCategory: "인도", provider: "삼성", isRecommended: false },
  { ticker: "200250", name: "KIWOOM 인도Nifty50(합성)", nameKr: "KIWOOM 인도Nifty50(합성)", category: "해외주식", subCategory: "인도", provider: "키움", isRecommended: false },
  { ticker: "195980", name: "PLUS 신흥국MSCI(합성 H)", nameKr: "PLUS 신흥국MSCI(합성 H)", category: "해외주식", subCategory: "신흥국", provider: "한화", isRecommended: false },
  { ticker: "354350", name: "HANARO 글로벌럭셔리S&P(합성)", nameKr: "HANARO 글로벌럭셔리S&P(합성)", category: "해외주식", subCategory: "글로벌", provider: "NH아문디", isRecommended: false },

  // ═══════════════════════════════════════════════════════════
  // 채권 ETF
  // ═══════════════════════════════════════════════════════════
  { ticker: "272580", name: "TIGER 단기채권액티브", nameKr: "TIGER 단기채권액티브", category: "채권", subCategory: "국내단기", provider: "미래에셋", isRecommended: true },
  { ticker: "153130", name: "KODEX 단기채권", nameKr: "KODEX 단기채권", category: "채권", subCategory: "국내단기", provider: "삼성", isRecommended: false },
  { ticker: "182490", name: "TIGER 단기선진하이일드(합성 H)", nameKr: "TIGER 단기선진하이일드(합성 H)", category: "채권", subCategory: "해외채권", provider: "미래에셋", isRecommended: false },
  ...
  { ticker: "451540", name: "TIGER 종합채권(AA-이상)액티브", nameKr: "TIGER 종합채권(AA-이상)액티브", category: "채권", subCategory: "국내종합", provider: "미래에셋", isRecommended: false },
  { ticker: "451600", name: "PLUS 국고채30년액티브", nameKr: "PLUS 국고채30년액티브", category: "채권", subCategory: "국내초장기", provider: "한화", isRecommended: false },
  ...
  { ticker: "130680", name: "TIGER 원유선물Enhanced(H)", nameKr: "TIGER 원유선물Enhanced(H)", category: "원자재", subCategory: "원유", provider: "미래에셋", isRecommended: true },
  ...
  { ticker: "271060", name: "KODEX 3대농산물선물(H)", nameKr: "KODEX 3대농산물선물(H)", category: "원자재", subCategory: "농산물", provider: "삼성", isRecommended: true },

  // ═══════════════════════════════════════════════════════════
  // 인버스/레버리지 ETF
  // ═══════════════════════════════════════════════════════════
  { ticker: "114800", name: "KODEX 인버스", nameKr: "KODEX 인버스", category: "인버스/레버리지", subCategory: "인버스", provider: "삼성", isRecommended: true },
  { ticker: "252670", name: "KODEX 200선물인버스2X", nameKr: "KODEX 200선물인버스2X", category: "인버스/레버리지", subCategory: "인버스", provider: "삼성", isRecommended: true },
  { ticker: "145670", name: "ACE 인버스", nameKr: "ACE 인버스", category: "인버스/레버리지", subCategory: "인버스", provider: "한국투자", isRecommended: false },
  { ticker: "251340", name: "KODEX 코스닥150선물인버스", nameKr: "KODEX 코스닥150선물인버스", category: "인버스/레버리지", subCategory: "인버스", provider: "삼성", isRecommended: false },
  { ticker: "252710", name: "TIGER 200선물인버스2X", nameKr: "TIGER 200선물인버스2X", category: "인버스/레버리지", subCategory: "인버스", provider: "미래에셋", isRecommended: false },

  // ═══════════════════════════════════════════════════════════
  // 통화 ETF
  // ═══════════════════════════════════════════════════════════
  { ticker: "261240", name: "KODEX 미국달러선물", nameKr: "KODEX 미국달러선물", category: "통화", subCategory: "달러", provider: "삼성", isRecommended: true },
  { ticker: "261250", name: "KODEX 미국달러선물레버리지", nameKr: "KODEX 미국달러선물레버리지", category: "통화", subCategory: "달러", provider: "삼성", isRecommended: false },
  { ticker: "261270", name: "KODEX 미국달러선물인버스", nameKr: "KODEX 미국달러선물인버스", category: "통화", subCategory: "달러", provider: "삼성", isRecommended: false },
  ...
  { ticker: "364690", name: "KODEX 혁신기술테마액티브", nameKr: "KODEX 혁신기술테마액티브", category: "테마", subCategory: "혁신기술", provider: "삼성", isRecommended: false },
  { ticker: "401470", name: "KODEX 메타버스액티브", nameKr: "KODEX 메타버스액티브", category: "테마", subCategory: "메타버스", provider: "삼성", isRecommended: false },
  { ticker: "456600", name: "TIME 글로벌AI인공지능액티브", nameKr: "TIME 글로벌AI인공지능액티브", category: "테마", subCategory: "AI", provider: "타임폴리오", isRecommended: false },
];
