...
export const assetPredictions: AssetPrediction[] = [
  // ── 금 (Gold) ─────────────────────────────────────────────────────────────
  {
    ...
    confidence: 85,
    timeframe: "3개월",
    targetRange: { low: 1100000, high: 1200000 },
    currentAtPrediction: 1077000,
    rationale: "관세전쟁 확대 + 인플레이션 재점화 + 중앙은행 금 매입 지속으로 순금 살때 110만원/돈 돌파 전망. 스태그플레이션 시나리오에서 금은 최적의 헤지 자산.",
  ...
  },
  {
    ...
    confidence: 80,
    timeframe: "6개월",
    targetRange: { low: 1120000, high: 1250000 },
    currentAtPrediction: 1077000,
  ...
  },
  {
    ...
    confidence: 70,
    timeframe: "1개월",
    targetRange: { low: 1080000, high: 1120000 },
    currentAtPrediction: 1077000,
  ...
  // ── WTI 원유 ──────────────────────────────────────────────────────────────
  {
    ...
    confidence: 65,
    timeframe: "3개월",
    targetRange: { low: 546, high: 618 },
    currentAtPrediction: 635,
  ...
  // ── 구리 ──────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 60,
    timeframe: "6개월",
    targetRange: { low: 13728, high: 15173 },
    currentAtPrediction: 13410,
  ...
  // ── 과거 적중/불일치 기록 (투명성) ────────────────────────────────────────
  {
    ...
    confidence: 80,
    timeframe: "3개월",
    targetRange: { low: 900000, high: 1020000 },
    currentAtPrediction: 880000,
    rationale: "지정학 불안 + 탈달러화 기조로 순금 살때 시세 사상 최고가 경신 예상.",
    keyAssumptions: ["중동 긴장", "중앙은행 금 매입"],
    publishedAt: "2025-12-01",
    result: "적중",
    actualOutcome: "순금 살때 2025년 12월 88만원/돈 → 2026년 2월 100만원/돈 돌파. 예측 범위 상단 도달.",
  },
  {
    id: "ap-sp500-past-1",
    assetId: "sp500",
  ...
  },
  {
    ...
    confidence: 60,
    timeframe: "3개월",
    targetRange: { low: 591, high: 655 },
    currentAtPrediction: 682,
    rationale: "OPEC 감산 이탈 + 미국 셰일 증산으로 유가 하락 예상.",
    keyAssumptions: ["OPEC 감산 약화", "미국 증산"],
    publishedAt: "2025-10-01",
    result: "부분적중",
    actualOutcome: "원유 682원/리터 → 635원/리터로 하락. 방향은 맞았으나 예측 범위 하단(591원) 미도달.",
  },
];
