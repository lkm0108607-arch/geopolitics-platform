...
export const assetPredictions: AssetPrediction[] = [
  // ── 금 (Gold) ─────────────────────────────────────────────────────────────
  {
    ...
    confidence: 85,
    timeframe: "3개월",
    targetRange: { low: 514000, high: 549000 },
    currentAtPrediction: 500000,
    rationale: "관세전쟁 확대 + 인플레이션 재점화 + 중앙은행 금 매입 지속으로 금 가격 52만원/돈 돌파 전망. 스태그플레이션 시나리오에서 금은 최적의 헤지 자산.",
  ...
  },
  {
    ...
    confidence: 80,
    timeframe: "6개월",
    targetRange: { low: 523000, high: 575000 },
    currentAtPrediction: 500000,
  ...
  },
  {
    ...
    confidence: 70,
    timeframe: "1개월",
    targetRange: { low: 505000, high: 523000 },
    currentAtPrediction: 500000,
  ...
  // ── 과거 적중/불일치 기록 (투명성) ────────────────────────────────────────
  {
    ...
    confidence: 80,
    timeframe: "3개월",
    targetRange: { low: 470000, high: 505000 },
    currentAtPrediction: 462000,
    rationale: "지정학 불안 + 탈달러화 기조로 금 사상 최고가 경신 예상.",
    keyAssumptions: ["중동 긴장", "중앙은행 금 매입"],
    publishedAt: "2025-12-01",
    result: "적중",
    actualOutcome: "금 가격 2025년 12월 46만2천원/돈 → 2026년 2월 50만원/돈 돌파. 예측 범위 상단 도달.",
  },
  {
    id: "ap-sp500-past-1",
    assetId: "sp500",
