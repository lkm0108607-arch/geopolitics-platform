    ...
    predictions: [
      {
        ...
        probability: 72,
        confidence: 78,
        targetRange: { low: 496000, high: 509000 },
        rationale: "중앙은행 금 매입 지속 + 관세 불확실성 확대로 안전자산 수요 증가. 기술적으로 48만8천원/돈 지지선 확인 후 반등 예상.",
        keyEvidence: [
        ...
        opposingExpertIds: [],
        scenario: "관세전쟁 확대 시나리오에서 금은 핵심 안전자산으로 수요 증가. 단기 목표 50만5천원/돈.",
        startPrice: 496000,
      },
      {
        id: "cp-1-sp500",
    ...
    predictions: [
      {
        ...
        probability: 75,
        confidence: 80,
        targetRange: { low: 502000, high: 514000 },
        rationale: "트럼프 관세 발표 후 안전자산 랠리 가속. 금 50만5천원/돈 돌파 임박.",
        keyEvidence: [
        ...
        opposingExpertIds: [],
        scenario: "관세전쟁 본격화 → 금 사상 최고가 경신 경로.",
        startPrice: 502000,
      },
      {
        id: "cp-2-sp500",
    ...
    predictions: [
      {
        ...
        probability: 78,
        confidence: 82,
        targetRange: { low: 505000, high: 516000 },
        rationale: "금 50만5천원/돈 돌파 후 새로운 지지대 형성 중. 관세전쟁 확대 시 추가 상승 여력.",
        keyEvidence: [
          "금 50만6천원/돈 사상 최고가 경신 (3/1)",
        ...
        supportingExpertIds: ["nouriel-roubini", "ray-dalio", "mohamed-el-erian"],
        opposingExpertIds: [],
        scenario: "금 52만3천원/돈 도달 시나리오. 관세전쟁 + 탈달러화가 구조적 상승 동력.",
        startPrice: 506000,
      },
      {
        id: "cp-3-sp500",
    ...
    predictions: [
      {
        ...
        probability: 80,
        confidence: 84,
        targetRange: { low: 507000, high: 517000 },
        rationale: "금 50만5천원/돈 지지 확인. 양회 부양 기대에도 관세 불확실성이 금 수요 지속.",
        keyEvidence: [
          "금 50만7천원/돈 돌파 — 3일 연속 사상 최고가",
          "ETF 순유입 $3.2B (3월 첫째주)",
        ...
        supportingExpertIds: ["nouriel-roubini", "ray-dalio"],
        opposingExpertIds: [],
        scenario: "금 52만3천원/돈 시대 진입 가시화. 3월 말 이전 돌파 가능.",
        startPrice: 507000,
      },
      {
        id: "cp-4-sp500",
  ...
  predictions: [
    {
      ...
      probability: 76,
      confidence: 81,
      targetRange: { low: 528000, high: 540000 },
      rationale: "금 52만2천원/돈에서 출발, 사상 최고가 경신 중. 관세전쟁 3단계 진입 + 중앙은행 수요 + 실질금리 하락이 삼중 상승 동력. 단기 차익실현 가능하나 추세 상승 유지.",
      keyEvidence: [
        "금 52만2천원/돈 사상 최고가 기록 (3/8)",
        "WGC: 2026년 중앙은행 금 순매수 전년비 +18% 전망",
        "미국 실질금리 1.72% → 1.65% 하락 (금 가격과 역상관)",
        "글로벌 금 ETF 3월 순유입 $4.8B (월간 최대 예상)",
        "JP모건: 금 54만원/돈 연내 돌파 전망 유지",
      ],
      sources: [
        { title: "JP Morgan Gold Outlook 2026", date: "2026-03-06" },
        { title: "WGC Central Bank Gold Reserves", date: "2026-03-07" },
        { title: "FRED Real Interest Rate Data", date: "2026-03-07" },
      ],
      supportingExpertIds: ["nouriel-roubini", "ray-dalio", "mohamed-el-erian"],
      opposingExpertIds: [],
      scenario: "관세전쟁 확대 + 스태그플레이션 우려로 금은 가장 확실한 안전자산. 53만원/돈 돌파는 시간문제이며, 3월 말~4월 초 예상. 단기 조정 시 52만~52만2천원/돈이 강력한 지지대.",
      startPrice: 522000,
      expertStats: {
...
const cycleResults: AICycleResult[] = [
  // Cycle 1 결과
  { cycleId: "cycle-2026-02-24", assetId: "gold", predictionId: "cp-1-gold", predictedDirection: "상승", actualDirection: "상승", predictedProbability: 72, result: "적중", actualOutcome: "금 50만원/돈 → 50만6천원/돈으로 1.2% 상승. 예측 범위 내.", evaluatedAt: "2026-02-27", newsEvidence: ["Bloomberg: Gold hits new record on tariff fears"] },
  ...
  // Cycle 2 결과
  { cycleId: "cycle-2026-02-27", assetId: "gold", predictionId: "cp-2-gold", predictedDirection: "상승", actualDirection: "상승", predictedProbability: 75, result: "적중", actualOutcome: "금 50만2천원/돈 → 50만6천원/돈. 관세전쟁 격화로 안전자산 랠리.", evaluatedAt: "2026-03-02" },
  ...
  // Cycle 3 결과
  { cycleId: "cycle-2026-03-02", assetId: "gold", predictionId: "cp-3-gold", predictedDirection: "상승", actualDirection: "상승", predictedProbability: 78, result: "적중", actualOutcome: "금 50만6천원/돈 → 50만8천원/돈. 사상 최고가 연일 경신.", evaluatedAt: "2026-03-05" },
  ...
  // Cycle 4 결과
  { cycleId: "cycle-2026-03-05", assetId: "gold", predictionId: "cp-4-gold", predictedDirection: "상승", actualDirection: "상승", predictedProbability: 80, result: "적중", actualOutcome: "금 50만7천원/돈 → 50만8천원/돈. 사상 최고가 유지.", evaluatedAt: "2026-03-08" },
...
const verificationLogs: VerificationLog[] = [
  {
    ...
    relevance: "high",
    impact: "supports",
    summary: "금 50만8천원/돈 신고가. 관세전쟁 심화로 안전자산 수요 폭증. 상승 예측 지지.",
  },
  {
    id: "vlog-2",
